...
fn f_cw_buffer_helper_0(cw_arg_x: f32, cw_arg_y: f32, cw_buffer_arg_2: i32, cw_arg_b: i32, cw_arg_time: f32, cw_arg_aa: f32, cw_thread: vec3<u32>, cw_block: vec3<u32>, cw_grid: vec3<u32>) -> vec4<f32> {
  ...
  var v_walk: f32 = sin(((v_age * cw_tmp_16) + b_E[(cw_buffer_offset_2 + (v_b + 12i))]));
  let cw_argument_index_17 = (cw_buffer_offset_2 + (v_b + 2i));
  let cw_argument_index_18 = (cw_buffer_offset_2 + (v_b + 3i));
  var v_moving: f32 = f_sat(cw_divide_f32(f_len2(b_E[cw_argument_index_17], b_E[cw_argument_index_18], cw_thread, cw_block, cw_grid), 60.0f), cw_thread, cw_block, cw_grid);
  ...
  if ((b_E[(cw_buffer_offset_2 + (v_b + 8i))] == 4.0f)) {
    ...
    var v_r: f32 = cw_tmp_19;
    var v_ring: f32 = (abs((f_len2(v_x, (v_y * 1.2f), cw_thread, cw_block, cw_grid) - v_r)) - 1.2f);
    v_c = f_paint(v_c, f_color(0.73f, 0.25f, 0.12f, cw_thread, cw_block, cw_grid), (f_ink(v_ring, v_aa, cw_thread, cw_block, cw_grid) * 0.8f), cw_thread, cw_block, cw_grid);
  }
  ...
  if ((v_type == 1i)) {
    ...
    v_c = f_paint(v_c, f_color(0.36f, 0.34f, 0.29f, cw_thread, cw_block, cw_grid), f_ink((f_len2(cw_divide_f32((v_rx - 12.0f), 1.2f), v_ry, cw_thread, cw_block, cw_grid) - 6.0f), v_aa, cw_thread, cw_block, cw_grid), cw_thread, cw_block, cw_grid);
    {
      ...
      loop {
        ...
        var v_step: f32 = ((v_walk * cw_tmp_22) * 3.0f);
    ...
    var cw_tmp_27: vec4<f32>;
    if ((v_type == 4i)) {
      cw_tmp_27 = f_color(0.46f, 0.8f, 0.72f, cw_thread, cw_block, cw_grid);
    } else {
      cw_tmp_27 = f_color(0.83f, 0.27f, 0.13f, cw_thread, cw_block, cw_grid);
    }
    v_c = f_paint(v_c, cw_tmp_27, v_eye, cw_thread, cw_block, cw_grid);
...
fn f_cw_buffer_helper_1(cw_arg_x: f32, cw_arg_y: f32, cw_buffer_arg_2: i32, cw_arg_aa: f32, cw_thread: vec3<u32>, cw_block: vec3<u32>, cw_grid: vec3<u32>) -> vec4<f32> {
  ...
  let cw_argument_index_28 = (cw_buffer_offset_2 + 2i);
  let cw_argument_index_29 = (cw_buffer_offset_2 + 3i);
  var v_walk: f32 = (sin((v_time * 13.0f)) * f_sat(cw_divide_f32(f_len2(b_S[cw_argument_index_28], b_S[cw_argument_index_29], cw_thread, cw_block, cw_grid), 130.0f), cw_thread, cw_block, cw_grid));
...
fn main(
  ...
  if (((f_len2(v_ox, v_oy, cw_thread, cw_block, cw_grid) > 235.0f) && (f_h2((v_gx + 82.0f), v_gy, cw_thread, cw_block, cw_grid) >= 0.35f))) {
    ...
    if ((v_d < v_aa)) {
      v_front = vec4<f32>(v_prop.x, v_prop.y, v_prop.z, f_ink(v_d, v_aa, cw_thread, cw_block, cw_grid));
      v_depth = v_oy;
    }
  }
  var v_tile: i32 = ((((v_iy / 32i) * ((cw_params.p_width + 31i) / 32i)) + (v_ix / 32i)) * 64i);
  var v_count: i32 = b_Tiles[v_tile];
  {
    ...
    loop {
      ...
      if ((b_Tiles[((v_tile + 1i) + v_j)] < 1000i)) {
        ...
        var v_sh: f32 = (exp(cw_divide_f32((-f_len2(cw_divide_f32(v_x, 1.5f), cw_divide_f32(v_y, 0.55f), cw_thread, cw_block, cw_grid)), 12.0f)) * 0.35f);
        v_c = (v_c * vec4<f32>((1.0f - v_sh)));
        var v_sprite: vec4<f32> = f_cw_buffer_helper_0(v_x, v_y, 0i, v_b, v_gameTime, v_aa, cw_thread, cw_block, cw_grid);
        if (((v_sprite.w > 0.01f) && (b_E[(v_b + 1i)] >= v_depth))) {
          v_front = v_sprite;
          v_depth = b_E[(v_b + 1i)];
        }
      }
  ...
  var v_pshadow: f32 = (exp(cw_divide_f32((-f_len2(cw_divide_f32((v_wx - b_S[0i]), 1.45f), cw_divide_f32((v_wy - b_S[1i]), 0.55f), cw_thread, cw_block, cw_grid)), 12.0f)) * 0.45f);
  ...
  if (((v_player.w > 0.01f) && (b_S[1i] >= v_depth))) {
    v_front = v_player;
    v_depth = b_S[1i];
  }
  v_c = f_blend(v_c, f_color(v_front.x, v_front.y, v_front.z, cw_thread, cw_block, cw_grid), v_front.w, cw_thread, cw_block, cw_grid);
  {
    ...
    loop {
      ...
      var v_fy: f32 = cw_tmp_12;
      var v_x: f32 = (v_wx - v_fx);
      var v_y: f32 = (v_wy - v_fy);
      if ((((abs(v_x) < 23.0f) && (abs(v_y) < 55.0f)) && (v_fy >= v_depth))) {
  ...
  }
  {
    ...
    loop {
      ...
      if (((v_id >= 1000i) && (v_id < 2000i))) {
        ...
        let cw_argument_index_13 = v_b;
        let cw_argument_index_14 = (v_b + 1i);
        var v_d: f32 = f_segment(v_wx, v_wy, b_P[cw_argument_index_13], b_P[cw_argument_index_14], (b_P[v_b] - (b_P[(v_b + 4i)] * 0.024f)), (b_P[(v_b + 1i)] - (b_P[(v_b + 5i)] * 0.024f)), cw_thread, cw_block, cw_grid);
  ...
  var v_rainX: f32 = ((v_wx * 0.1f) + (v_wy * 0.025f));
  var v_rainY: f32 = ((v_wy * 0.07f) + (v_time * 10.0f));
  var v_cell: f32 = f_h2(floor(v_rainX), floor(v_rainY), cw_thread, cw_block, cw_grid);
  var v_rain: f32 = ((f_ink((abs((f_frac(v_rainX, cw_thread, cw_block, cw_grid) - 0.5f)) - 0.035f), 0.035f, cw_thread, cw_block, cw_grid) * (1.0f - f_frac(v_rainY, cw_thread, cw_block, cw_grid))) * 0.1f);
  if ((v_cell > 0.83f)) {
    v_c = (v_c + f_color((v_rain * 0.8f), v_rain, v_rain, cw_thread, cw_block, cw_grid));
  }
