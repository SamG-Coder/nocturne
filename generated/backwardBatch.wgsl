// CUDA WebShader 0.1.0. Generated from kernel backwardBatch.
...
fn main(
  ...
  var v_loss: f32 = 0.0f;
  {
    ...
    loop {
      if (!(v_o < 2i)) { break; }
      var v_y: f32 = b_Work[((v_b + 18i) + v_o)];
      var v_d: f32 = (v_y - b_Work[((v_b + 16i) + v_o)]);
      b_Work[((v_b + 84i) + v_o)] = v_d;
      v_loss = (v_loss + ((v_d * v_d) * 0.5f));
      continuing {
        v_o += i32(1);
      }
    }
  }
  b_Work[(v_b + 86i)] = v_loss;
  {
    var v_h: i32 = 0i;
    loop {
      if (!(v_h < 32i)) { break; }
      var v_hval: f32 = b_Work[((v_b + 20i) + v_h)];
      var v_d: f32 = ((b_Work[(v_b + 84i)] * b_W[(544i + v_h)]) + (b_Work[(v_b + 85i)] * b_W[(576i + v_h)]));
      b_Work[((v_b + 52i) + v_h)] = (v_d * (1.0f - (v_hval * v_hval)));
      continuing {
        v_h += i32(1);
      }
    }
