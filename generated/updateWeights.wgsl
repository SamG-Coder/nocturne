// CUDA WebShader 0.1.0. Generated from kernel updateWeights.
@group(0) @binding(0) var<storage, read> b_S: array<f32>;
@group(0) @binding(1) var<storage, read> b_Brain: array<f32>;
@group(0) @binding(2) var<storage, read> b_Grad: array<f32>;
@group(0) @binding(3) var<storage, read_write> b_W: array<f32>;
@group(0) @binding(4) var<storage, read_write> b_M: array<f32>;
@group(0) @binding(5) var<storage, read_write> b_V: array<f32>;
...
fn main(
  ...
  var v_grad: f32 = b_Grad[v_i];
  var v_m: f32 = ((0.9f * b_M[v_i]) + (0.1f * v_grad));
  var v_v: f32 = ((0.999f * b_V[v_i]) + ((0.001f * v_grad) * v_grad));
  b_M[v_i] = v_m;
  b_V[v_i] = v_v;
  let cw_argument_index_0 = 0i;
  var v_mh: f32 = cw_divide_f32(v_m, (1.0f - cw_pow_f32(0.9f, b_Brain[cw_argument_index_0])));
  let cw_argument_index_1 = 0i;
  var v_vh: f32 = cw_divide_f32(v_v, (1.0f - cw_pow_f32(0.999f, b_Brain[cw_argument_index_1])));
