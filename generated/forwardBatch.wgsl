// CUDA WebShader 0.1.0. Generated from kernel forwardBatch.
  ...
  var v_b: i32 = (v_i * 88i);
  {
    ...
    loop {
      ...
      var v_z: f32 = b_W[(512i + v_h)];
      {
        ...
        loop {
          if (!(v_j < 16i)) { break; }
          v_z = (v_z + (b_W[((v_h * 16i) + v_j)] * b_Work[(v_b + v_j)]));
          continuing {
            v_j += i32(1);
          }
        }
      }
      b_Work[((v_b + 20i) + v_h)] = f_activation(v_z, cw_thread, cw_block, cw_grid);
      continuing {
        v_h += i32(1);
      }
    }
  }
  {
    ...
    loop {
      ...
      var v_z: f32 = b_W[(608i + v_o)];
      {
        ...
        loop {
          if (!(v_h < 32i)) { break; }
          v_z = (v_z + (b_W[((544i + (v_o * 32i)) + v_h)] * b_Work[((v_b + 20i) + v_h)]));
          continuing {
            v_h += i32(1);
          }
        }
      }
      b_Work[((v_b + 18i) + v_o)] = ((b_Work[(v_b + v_o)] * cw_divide_f32(90.0f, 140.0f)) + v_z);
      continuing {
        v_o += i32(1);
      }
    }
