// CUDA WebShader 0.1.0. Generated from kernel synthAudio.
@group(0) @binding(0) var<storage, read_write> b_Audio: array<f32>;
struct CWParams {
  p_count: i32,
  p_sampleRate: i32,
  cw_pad_8: u32,
...
fn main(
  ...
  var v_section: i32 = (v_i / cw_params.p_sampleRate);
  var v_t: f32 = cw_divide_f32(f32((v_i % cw_params.p_sampleRate)), f32(cw_params.p_sampleRate));
  var v_value: f32 = 0.0f;
  var v_noise: f32 = (f_hashf(f32(v_i), cw_thread, cw_block, cw_grid) - 0.5f);
  if ((v_section == 0i)) {
    v_value = ((((v_noise * 1.2f) + sin((((v_t * 3.14159265359f) * 2.0f) * (115.0f - (50.0f * v_t))))) * exp(((-v_t) * 38.0f))) * 0.4f);
  }
  if ((v_section == 1i)) {
    v_value = ((((v_noise * 0.75f) + (sin((((v_t * 3.14159265359f) * 2.0f) * (430.0f - (270.0f * v_t)))) * 0.15f)) * exp(((-v_t) * 14.0f))) * 0.4f);
  }
  if ((v_section == 2i)) {
    v_value = ((((v_noise * 0.5f) + sin((((v_t * 3.14159265359f) * 2.0f) * 58.0f))) * exp(((-v_t) * 10.0f))) * 0.23f);
  }
  if ((v_section == 3i)) {
    v_value = (((sin((((v_t * 3.14159265359f) * 2.0f) * 880.0f)) + (0.35f * sin((((v_t * 3.14159265359f) * 2.0f) * 1320.0f)))) * exp(((-v_t) * 18.0f))) * 0.11f);
  }
  if ((v_section == 4i)) {
    v_value = (((((sin((((v_t * 3.14159265359f) * 2.0f) * 220.0f)) + (sin((((v_t * 3.14159265359f) * 2.0f) * 330.0f)) * 0.6f)) + (sin((((v_t * 3.14159265359f) * 2.0f) * 440.0f)) * 0.4f)) * exp(((-v_t) * 3.5f))) * (1.0f - exp(((-v_t) * 40.0f)))) * 0.14f);
  }
  if ((v_section == 5i)) {
    v_value = ((((v_noise * 0.5f) + (sin((((v_t * 3.14159265359f) * 2.0f) * (150.0f + (220.0f * v_t)))) * 0.15f)) * exp(((-v_t) * 13.0f))) * 0.2f);
  }
  if ((v_section == 6i)) {
    v_value = (((sin((((v_t * 3.14159265359f) * 2.0f) * (72.0f - (28.0f * v_t)))) + (v_noise * 0.12f)) * exp(((-v_t) * 2.8f))) * 0.25f);
  }
  if ((v_section == 7i)) {
    v_value = ((((sin((((v_t * 3.14159265359f) * 2.0f) * 110.0f)) + (sin((((v_t * 3.14159265359f) * 2.0f) * 165.0f)) * 0.3f)) + (v_noise * 0.2f)) * exp(((-v_t) * 5.0f))) * 0.25f);
  }
  if ((v_section >= 8i)) {
    var v_at: f32 = cw_divide_f32(f32((v_i - (8i * cw_params.p_sampleRate))), f32(cw_params.p_sampleRate));
    var v_swell: f32 = (0.7f + (0.3f * sin(((v_at * 3.14159265359f) * 0.25f))));
    v_value = (((((sin((((v_at * 3.14159265359f) * 2.0f) * 55.0f)) * 0.2f) + (sin((((v_at * 3.14159265359f) * 2.0f) * 82.5f)) * 0.1f)) + (sin((((v_at * 3.14159265359f) * 2.0f) * 110.125f)) * 0.06f)) * v_swell) + (v_noise * 0.008f));
  }
  b_Audio[v_i] = max((-1.0f), min(1.0f, v_value));
}
